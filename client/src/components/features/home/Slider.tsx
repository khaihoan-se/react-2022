...
import SlideImg from "../../../asset/slider-01.png";

const Slider = () => {
    return (
        <div className="group relative w-full h-[550px] overflow-hidden">
            {/* Img */}
            <Image className="max-w-full min-w-full min-h-full object-cover absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%]" src={SlideImg} alt="slider...." />
            ...
            <div className="absolute left-12 top-1/2 -translate-y-1/2 w-full md:w-[45%]">
                <h1 className="text-2xl font-bold uppercase md:text-4xl line-clamp-2 sm:line-clamp-3 md:line-clamp-4">Shikimori-san Không Chỉ Dễ Thương Thôi Đâu</h1>
                ...
                <p className="hidden mt-2 text-base md:block text-gray-200 md:line-clamp-5">Tensei-shitara Slime datta ken, hay gọi tắt là Tensura là loạt light novel kỳ ảo do Fuse sáng tác và Mitz Vah vẽ minh hoạ. Tiểu thuyết được đăng trực tuyến trên trang web xuất bản tiểu thuyết do người dùng viết tên là Shōsetsuka ni Narō từ năm 2013 đến năm 2016.</p>
            </div>
        </div>
    )
}
